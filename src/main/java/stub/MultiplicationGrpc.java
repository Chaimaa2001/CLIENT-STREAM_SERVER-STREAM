...
public final class MultiplicationGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<stub.SalutationOuterClass.MultiplicationRequest,
      stub.SalutationOuterClass.MultiplicatonResponse> getGetMultiplicationTableMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMultiplicationTable",
      requestType = stub.SalutationOuterClass.MultiplicationRequest.class,
      responseType = stub.SalutationOuterClass.MultiplicatonResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<stub.SalutationOuterClass.MultiplicationRequest,
      stub.SalutationOuterClass.MultiplicatonResponse> getGetMultiplicationTableMethod() {
    io.grpc.MethodDescriptor<stub.SalutationOuterClass.MultiplicationRequest, stub.SalutationOuterClass.MultiplicatonResponse> getGetMultiplicationTableMethod;
      ...
      synchronized (MultiplicationGrpc.class) {
        if ((getGetMultiplicationTableMethod = MultiplicationGrpc.getGetMultiplicationTableMethod) == null) {
          MultiplicationGrpc.getGetMultiplicationTableMethod = getGetMultiplicationTableMethod = 
              io.grpc.MethodDescriptor.<stub.SalutationOuterClass.MultiplicationRequest, stub.SalutationOuterClass.MultiplicatonResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Multiplication", "GetMultiplicationTable"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.SalutationOuterClass.MultiplicationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stub.SalutationOuterClass.MultiplicatonResponse.getDefaultInstance()))
  ...
  public static abstract class MultiplicationImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getMultiplicationTable(stub.SalutationOuterClass.MultiplicationRequest request,
        io.grpc.stub.StreamObserver<stub.SalutationOuterClass.MultiplicatonResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                stub.SalutationOuterClass.MultiplicationRequest,
                stub.SalutationOuterClass.MultiplicatonResponse>(
  ...
  public static final class MultiplicationBlockingStub extends io.grpc.stub.AbstractStub<MultiplicationBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<stub.SalutationOuterClass.MultiplicatonResponse> getMultiplicationTable(
        stub.SalutationOuterClass.MultiplicationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MULTIPLICATION_TABLE:
          serviceImpl.getMultiplicationTable((stub.SalutationOuterClass.MultiplicationRequest) request,
              (io.grpc.stub.StreamObserver<stub.SalutationOuterClass.MultiplicatonResponse>) responseObserver);
          break;
        default:
